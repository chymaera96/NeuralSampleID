...
class GPUPeakExtractorv2(nn.Module):
    ...
    def forward(self, spec_tensor):
        ...
        try:
            ...
            # Validation (and MixCo) case
            # print(str(e))
            # print("shapes of T_tensor, F_tensor, peaks: ", self.T_tensor.shape, self.F_tensor.shape, peaks.shape)
        ...
        # print(f"Log: Peak extraction completed with shape {tensor.shape}")
