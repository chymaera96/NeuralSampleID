# Ablation: generating audio fingerprints for a given audio file
...
parser = argparse.ArgumentParser(description='GraFPrint Wrapper')
...
def create_db(dataloader, model, augment, output_dir, concat=True):
    fp = []
